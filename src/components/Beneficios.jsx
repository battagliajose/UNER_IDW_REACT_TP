      ...
      <div className="container bg-dark text-white pb-3">
        <div className="row">
          <div className="col-md justify-content-start align-items-center">
            <h2>
              Millones de opciones para tus
              <span className="rojito"> vacaciones inolvidables</span> alrededor
              del mundo!
            </h2>
          ...
          <div className="col-md justify-content-start align-items-center">
            <p>
              Disfruta de servicios excepcionales, ubicaciones privilegiadas y
              las mejores tarifas.
            </p>
            <p>
              <strong>
                ¡Reserva ahora para una
                <span className="rojito"> experiencia única</span>!
              </strong>
            </p>
          </div>
        </div>
