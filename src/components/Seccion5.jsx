    ...
    <div className="container-fluid contenedorSeccion5">
      <div className="row fila-texto">
        ...
        <div className="col-md-6 texto-session5 ">
          <p>
            Reserva ahora y disfruta de tarifas especiales que te permitirán
            vivir momentos inolvidables. Relájate en nuestras elegantes
            habitaciones, deleita tu paladar con exquisita gastronomía en
